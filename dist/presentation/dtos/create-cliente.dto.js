...
__decorate([
    (0, class_validator_1.IsNumber)({}, { message: 'A renda deve ser um número.' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'A renda é obrigatória.' }),
    __metadata("design:type", Number)
], CreateClienteDto.prototype, "renda", void 0);
